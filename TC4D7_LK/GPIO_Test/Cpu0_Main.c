 ...
 * \description A wait function is used to add delays between switching on and switching off an LED on port pin P33.0.
 * \name Blinky_LED_1_KIT_TC499_COM_TRB
 * \version V1.0.1
 * \board TriBoard TC499A COM, KIT_TC499_TRB_COM, TC499XE_AA-Step_CC_COM
