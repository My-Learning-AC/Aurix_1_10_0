...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define PIN9                         9                           /* LED used in RX ISR is connected to this pin       */
#define PIN10                        10
#define TIME_STAMP_NOT_ENABLED      (boolean)0
#define DO_NOT_CARE_STD_TYPE        (IfxCan_StdFilterType)0
#define DO_NOT_CARE_XTD_TYPE        (IfxCan_XtdFilterType)0
...
#define ISR_PRIORITY_CAN_RX_BUFFER  3                           /* Define the dedicated RX buffer interrupt priority */
#define ISR_PRIORITY_CAN_RX_FIFO_0  4                           /* Define the RX FIFO 0 interrupt priority           */
#define ISR_PRIORITY_CAN_RX_FIFO_1  5                           /* Define the RX FIFO 1 interrupt priority           */
...
#define NUMBER_OF_STND_ID_FILTERS   1                           /* Define the number of standard ID filter elements  */
#define NUMBER_OF_EXTD_ID_FILTERS   1                           /* Define the number of extended ID filter elements  */
...
#define NUMBER_OF_CAN_MESSAGES      1                          /* Define the number of CAN messages to be sent      */
...
/*-------------------------------------------------Global variables--------------------------------------------------*/
/*********************************************************************************************************************/
IFX_EXTERN volatile canCommunicationStatusType g_status;
IFX_EXTERN IfxPort_Pin_Config g_led;
