 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_NVM_DMU/V0.2.1.1.1
...
typedef struct _Ifx_DMU_GP_CSRM_PROTECT_Bits
{
    ...
    __I  Ifx_UReg_32Bit PRODISUDATA0:1;    /**< \brief [6:6] Secure retest password protection disabled (rh) */
    __I  Ifx_UReg_32Bit PRODISUDATA1:1;    /**< \brief [7:7] Secure retest password protection disabled (rh) */
