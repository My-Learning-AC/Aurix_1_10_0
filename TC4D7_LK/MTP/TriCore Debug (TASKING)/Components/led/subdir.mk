...
COMPILED_SRCS += \
Components/led/led.src 

C_DEPS += \
Components/led/led.d 

OBJS += \
Components/led/led.o 


# Each subdirectory must supply rules for building sources it contributes
Components/led/led.src: ../Components/led/led.c Components/led/subdir.mk
...
Components/led/led.o: Components/led/led.src Components/led/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 --user-mode=hypervisor --core=tc1.8 -o  "$@" "$<"

clean: clean-Components-2f-led

clean-Components-2f-led:
	-$(RM) Components/led/led.d Components/led/led.o Components/led/led.src

.PHONY: clean-Components-2f-led
