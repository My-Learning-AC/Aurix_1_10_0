...
C_SRCS += \
../Components/hsphy/hsphy.c 

COMPILED_SRCS += \
Components/hsphy/hsphy.src 

C_DEPS += \
Components/hsphy/hsphy.d 

OBJS += \
Components/hsphy/hsphy.o 


# Each subdirectory must supply rules for building sources it contributes
Components/hsphy/hsphy.src: ../Components/hsphy/hsphy.c Components/hsphy/subdir.mk
...
Components/hsphy/hsphy.o: Components/hsphy/hsphy.src Components/hsphy/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 --user-mode=hypervisor --core=tc1.8 -o  "$@" "$<"

clean: clean-Components-2f-hsphy

clean-Components-2f-hsphy:
	-$(RM) Components/hsphy/hsphy.d Components/hsphy/hsphy.o Components/hsphy/hsphy.src

.PHONY: clean-Components-2f-hsphy
