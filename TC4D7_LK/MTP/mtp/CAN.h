...
#define ISR_PRIORITY_CAN_RX_BUFFER  4                           /* Define the dedicated RX buffer interrupt priority */
...
#define WAIT_TIME                   100                           /* Number of milliseconds to wait after transmission */
