...
typedef struct
{
    ...
    IfxCss_channelDataInCfg     dataInCfg;              /**< \brief Defines how input data is written to input FIFO */
...
typedef struct
{
    ...
    IfxCss_channelDataInCfg            dataInCfg;             /**< \brief Configure how input data is written to input FIFO */
