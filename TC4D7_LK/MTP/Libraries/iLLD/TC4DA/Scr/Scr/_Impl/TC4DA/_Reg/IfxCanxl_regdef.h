...
/** \brief RX FIFO queue 0 current address pointer */
...
/** \brief RX FIFO queue 0 data container start address */
...
/** \brief RX FIFO queue 0 read address pointer */
typedef struct _Ifx_CANXL_N_RX_FQ_RD_ADD_PT_Bits
{
    __IO Ifx_Strict_32Bit VAL:32;          /**< \brief [31:0] VAL (rw) */
} Ifx_CANXL_N_RX_FQ_RD_ADD_PT_Bits;

/** \brief RX FIFO queue 0 link list and data container size */
...
/** \brief RX FIFO queue 0 link list start address */
...
/** \brief TX FIFO queue 0 current address pointer register */
...
/** \brief TX FIFO queue 0 size register */
...
/** \brief TX FIFO queue 0 start address register */
...
{
       __I  Ifx_CANXL_N_TX_FQ_ADD_PT            ADD_PT;                 /**< \brief 0, TX FIFO queue 0 current address pointer register*/
       __IO Ifx_CANXL_N_TX_FQ_START_ADD         START_ADD;              /**< \brief 4, TX FIFO queue 0 start address register*/
       __IO Ifx_CANXL_N_TX_FQ_SIZE              SIZE;                   /**< \brief 8, TX FIFO queue 0 size register*/
...
{
       __I  Ifx_CANXL_N_RX_FQ_ADD_PT            ADD_PT;                 /**< \brief 0, RX FIFO queue 0 current address pointer*/
       __IO Ifx_CANXL_N_RX_FQ_START_ADD         START_ADD;              /**< \brief 4, RX FIFO queue 0 link list start address*/
       __IO Ifx_CANXL_N_RX_FQ_SIZE              SIZE;                   /**< \brief 8, RX FIFO queue 0 link list and data container size*/
       __IO Ifx_CANXL_N_RX_FQ_DC_START_ADD      DC_START_ADD;           /**< \brief C, RX FIFO queue 0 data container start address*/
       __IO Ifx_CANXL_N_RX_FQ_RD_ADD_PT         RD_ADD_PT;              /**< \brief 10, RX FIFO queue 0 read address pointer*/
...
{
       __IO Ifx_CANXL_N_TX_FILTER_REFVAL        REFVAL;                 /**< \brief 0, TX filter reference value register 0*/
