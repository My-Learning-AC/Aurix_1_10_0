 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_PCIE/V13.1.1.0.10
...
typedef struct _Ifx_PCIE_USP_LNK_STAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit LINKINT:1;         /**< \brief [3:3] Link Autonomous Bandwidth Interrupt. The interrupt can be triggered when the LIK_INTEN.LINKINTEN is asserted. (rh) */
