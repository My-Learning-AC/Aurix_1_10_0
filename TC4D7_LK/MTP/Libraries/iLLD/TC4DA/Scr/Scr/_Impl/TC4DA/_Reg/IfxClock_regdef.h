 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_Clock/V0.2.1.1.7
...
typedef struct _Ifx_CLOCK_SYSCCUCON1_Bits
{
    ...
    __IO Ifx_UReg_32Bit RCBDIV:4;          /**< \brief [7:4] RCB divider reload value (rw) */
...
typedef volatile struct _Ifx_CLOCK
{
       ...
       __I  Ifx_UReg_8Bit                       reserved_514[15083];    /**< \brief 514, \internal Reserved */
} Ifx_CLOCK;
