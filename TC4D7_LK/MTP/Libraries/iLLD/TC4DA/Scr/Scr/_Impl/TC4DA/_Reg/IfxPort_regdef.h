...
/** \brief Configuration and control register for PORT16 LDO */
typedef struct _Ifx_P_P16LDOCTRL_EN_CONF_RD_DIAG_Bits
{
    __IO Ifx_UReg_32Bit ENABLE:1;          /**< \brief [0:0] Main Enable for complete IP (rwh) */
    __IO Ifx_UReg_32Bit SHORT_TIMER:2;     /**< \brief [2:1] Timer configuration for Short Detection (rw) */
    __IO Ifx_UReg_32Bit SHHEN:1;           /**< \brief [3:3] Short Detection Enabling (rw) */
    __IO Ifx_UReg_32Bit SH_LDO_OFF_EN:1;    /**< \brief [4:4] Short Detection OFF LDO enabling (SHHEN = 1) (rw) */
    __I  Ifx_UReg_32Bit SHOFF_PMS:1;       /**< \brief [5:5] Indication that LDO will be shut down in several clk cycles. This bit is set high only when SH_LDO_OFF_EN is 1 and persistent short to VDD detected (rh) */
    __I  Ifx_UReg_32Bit SH_VDD:1;          /**< \brief [6:6] Indication that short to VDD was detected (rh) */
    __I  Ifx_UReg_32Bit :25;               /**< \brief [31:7] \internal Reserved */
} Ifx_P_P16LDOCTRL_EN_CONF_RD_DIAG_Bits;

/** \brief Test mode register for PORT16 LDO (Trimming, DFT and AMUX_SEL, SCAN_CLOCK_SPEED) */
typedef struct _Ifx_P_P16LDOCTRL_TM_REGISTERS_Bits
{
    __IO Ifx_UReg_32Bit DFT_MUX_EN:1;      /**< \brief [0:0] DFT Mux Enable for Analog (rw) */
    __IO Ifx_UReg_32Bit DFT_MUX_SEL:3;     /**< \brief [3:1] AMUX_SEL code pre-decoding (rw) */
    __IO Ifx_UReg_32Bit BURN_IN_ENABLE:1;    /**< \brief [4:4] BURN_IN for Analog (rw) */
    __IO Ifx_UReg_32Bit SCAN_MODE_FAST_SLOW:1;    /**< \brief [5:5] 0-> SCAN_CLOCK_100MHz , 1-> SCAN_CLOCK_50MHz (rw) */
    __I  Ifx_UReg_32Bit :26;               /**< \brief [31:6] \internal Reserved */
} Ifx_P_P16LDOCTRL_TM_REGISTERS_Bits;

/** \brief Trimming register for PORT16 LDO */
typedef struct _Ifx_P_P16LDOCTRL_TRIM_CONF_PROT_Bits
{
    __IO Ifx_UReg_32Bit TRIM_FINE:3;       /**< \brief [2:0] Fine Trim LDO (rw) */
    __IO Ifx_UReg_32Bit TRIM_COARSE:3;     /**< \brief [5:3] Coarse Trim LDO (rw) */
    __I  Ifx_UReg_32Bit :26;               /**< \brief [31:6] \internal Reserved */
} Ifx_P_P16LDOCTRL_TRIM_CONF_PROT_Bits;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_P_P16LDOCTRL_EN_CONF_RD_DIAG_Bits B;    /**< \brief Bitfield access */
} Ifx_P_P16LDOCTRL_EN_CONF_RD_DIAG;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_P_P16LDOCTRL_TM_REGISTERS_Bits B;    /**< \brief Bitfield access */
} Ifx_P_P16LDOCTRL_TM_REGISTERS;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_P_P16LDOCTRL_TRIM_CONF_PROT_Bits B;    /**< \brief Bitfield access */
} Ifx_P_P16LDOCTRL_TRIM_CONF_PROT;
...
/******************************************************************************/
/******************************************************************************/
/** \addtogroup IfxSfr_P_P16LDOCTRL_struct
 * \{  */
/******************************************************************************/
/** \name Object L1
 * \{  */
/** \brief P16LDOCTRL object */
typedef volatile struct _Ifx_P_P16LDOCTRL
{
       __IO Ifx_P_P16LDOCTRL_EN_CONF_RD_DIAG    EN_CONF_RD_DIAG;        /**< \brief 0, Configuration and control register for PORT16 LDO*/
       __I  Ifx_UReg_8Bit                       reserved_4[4];          /**< \brief 4, \internal Reserved */
       __IO Ifx_P_P16LDOCTRL_TM_REGISTERS       TM_REGISTERS;           /**< \brief 8, Test mode register for PORT16 LDO (Trimming, DFT and AMUX_SEL, SCAN_CLOCK_SPEED)*/
       __IO Ifx_P_P16LDOCTRL_TRIM_CONF_PROT     TRIM_CONF_PROT;         /**< \brief C, Trimming register for PORT16 LDO*/
} Ifx_P_P16LDOCTRL;
...
typedef volatile struct _Ifx_P
{
       ...
       __IO Ifx_P_P16LDOCTRL                    P16LDOCTRL[1];          /**< \brief 190, Trimming register for PORT16 LDO*/
       __I  Ifx_UReg_8Bit                       reserved_1A0[352];      /**< \brief 1A0, \internal Reserved */
