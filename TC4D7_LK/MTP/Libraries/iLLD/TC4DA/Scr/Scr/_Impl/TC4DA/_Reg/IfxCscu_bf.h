...
#define IFX_CSCU_CSRM2HT_DATA_LEN (30u)

/** \brief Mask for Ifx_CSCU_CSRM2HT_Bits.DATA */
#define IFX_CSCU_CSRM2HT_DATA_MSK (0x3fffffffu)

/** \brief Offset for Ifx_CSCU_CSRM2HT_Bits.DATA */
#define IFX_CSCU_CSRM2HT_DATA_OFF (0u)

/** \brief Length for Ifx_CSCU_CSRM2HT_Bits.RL */
#define IFX_CSCU_CSRM2HT_RL_LEN (2u)

/** \brief Mask for Ifx_CSCU_CSRM2HT_Bits.RL */
#define IFX_CSCU_CSRM2HT_RL_MSK (0x3u)

/** \brief Offset for Ifx_CSCU_CSRM2HT_Bits.RL */
#define IFX_CSCU_CSRM2HT_RL_OFF (30u)
...
/** \brief Length for Ifx_CSCU_STMEM1_Bits.R0 */
#define IFX_CSCU_STMEM1_R0_LEN (6u)

/** \brief Mask for Ifx_CSCU_STMEM1_Bits.R0 */
#define IFX_CSCU_STMEM1_R0_MSK (0x3fu)

/** \brief Offset for Ifx_CSCU_STMEM1_Bits.R0 */
#define IFX_CSCU_STMEM1_R0_OFF (0u)

/** \brief Length for Ifx_CSCU_STMEM1_Bits.RAMIN */
#define IFX_CSCU_STMEM1_RAMIN_LEN (2u)

/** \brief Mask for Ifx_CSCU_STMEM1_Bits.RAMIN */
#define IFX_CSCU_STMEM1_RAMIN_MSK (0x3u)

/** \brief Offset for Ifx_CSCU_STMEM1_Bits.RAMIN */
#define IFX_CSCU_STMEM1_RAMIN_OFF (6u)
...
/** \brief Length for Ifx_CSCU_STMEM1_Bits.R10 */
#define IFX_CSCU_STMEM1_R10_LEN (1u)

/** \brief Mask for Ifx_CSCU_STMEM1_Bits.R10 */
#define IFX_CSCU_STMEM1_R10_MSK (0x1u)

/** \brief Offset for Ifx_CSCU_STMEM1_Bits.R10 */
#define IFX_CSCU_STMEM1_R10_OFF (10u)
...
/** \brief Length for Ifx_CSCU_STMEM3_Bits.DATA */
#define IFX_CSCU_STMEM3_DATA_LEN (32u)

/** \brief Mask for Ifx_CSCU_STMEM3_Bits.DATA */
#define IFX_CSCU_STMEM3_DATA_MSK (0xffffffffu)

/** \brief Offset for Ifx_CSCU_STMEM3_Bits.DATA */
#define IFX_CSCU_STMEM3_DATA_OFF (0u)

/** \brief Length for Ifx_CSCU_LCS_Bits.LCS */
#define IFX_CSCU_LCS_LCS_LEN (7u)

/** \brief Mask for Ifx_CSCU_LCS_Bits.LCS */
#define IFX_CSCU_LCS_LCS_MSK (0x7fu)

/** \brief Offset for Ifx_CSCU_LCS_Bits.LCS */
#define IFX_CSCU_LCS_LCS_OFF (0u)

/** \brief Length for Ifx_CSCU_LCS_Bits.R7 */
#define IFX_CSCU_LCS_R7_LEN (24u)

/** \brief Mask for Ifx_CSCU_LCS_Bits.R7 */
#define IFX_CSCU_LCS_R7_MSK (0xffffffu)

/** \brief Offset for Ifx_CSCU_LCS_Bits.R7 */
#define IFX_CSCU_LCS_R7_OFF (7u)

/** \brief Length for Ifx_CSCU_LCS_Bits.LCK */
#define IFX_CSCU_LCS_LCK_LEN (1u)

/** \brief Mask for Ifx_CSCU_LCS_Bits.LCK */
#define IFX_CSCU_LCS_LCK_MSK (0x1u)

/** \brief Offset for Ifx_CSCU_LCS_Bits.LCK */
#define IFX_CSCU_LCS_LCK_OFF (31u)

/** \brief Length for Ifx_CSCU_ASFW_Bits.DATA */
#define IFX_CSCU_ASFW_DATA_LEN (31u)

/** \brief Mask for Ifx_CSCU_ASFW_Bits.DATA */
#define IFX_CSCU_ASFW_DATA_MSK (0x7fffffffu)

/** \brief Offset for Ifx_CSCU_ASFW_Bits.DATA */
#define IFX_CSCU_ASFW_DATA_OFF (0u)

/** \brief Length for Ifx_CSCU_ASFW_Bits.LCK */
#define IFX_CSCU_ASFW_LCK_LEN (1u)

/** \brief Mask for Ifx_CSCU_ASFW_Bits.LCK */
#define IFX_CSCU_ASFW_LCK_MSK (0x1u)

/** \brief Offset for Ifx_CSCU_ASFW_Bits.LCK */
#define IFX_CSCU_ASFW_LCK_OFF (31u)
