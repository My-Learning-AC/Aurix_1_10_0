...
typedef struct _Ifx_XSPI_CTRLR0_Bits
{
    ...
    __I  Ifx_UReg_32Bit SPI_DWS_EN:1;      /**< \brief [25:25] Enable Dynamic wait states in SPI mode of operation (r) */
    __IO Ifx_UReg_32Bit CLK_LOOP_EN:1;     /**< \brief [26:26] Clock loop back enable bit (rw) */
    __I  Ifx_UReg_32Bit RSVD_CTRLR0_27_31:4;    /**< \brief [30:27] Reserved bits - read as zero (r) */
    __I  Ifx_UReg_32Bit SSI_IS_MST:1;      /**< \brief [31:31] This field selects if DWC_ssi is working in Master or Slave mode (r) */
...
typedef struct _Ifx_XSPI_IMR_Bits
{
    ...
    __IO Ifx_UReg_32Bit RXFIM:1;           /**< \brief [4:4] Receive FIFO Full Interrupt Mask 0 - ssi_rxf_intr interrupt is masked 1 - ssi_rxf_intr interrupt is not masked (rw) */
    ...
    __I  Ifx_UReg_32Bit RSVD_9_IMR:1;      /**< \brief [9:9] Reserved bits - read as zero (r) */
    ...
    __I  Ifx_UReg_32Bit RSVD_12_32_IMR:20;    /**< \brief [31:12] Reserved bits - read as zero (r) */
} Ifx_XSPI_IMR_Bits;
...
typedef struct _Ifx_XSPI_INTSTAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit FPIMST:1;          /**< \brief [4:4] Error related to UBS issues in FPI master from S2F bridge: Address and read data EDCs,  inconsistancies of data phase signals (ready, ack and dp_inv) (rh) */
    __I  Ifx_UReg_32Bit FPISLV:1;          /**< \brief [5:5] Error signal generated by UBS due to issues such as : Address and write data EDCs , inconsistancies of data phase signals (ready, ack and dp_inv), inconsistencies in abort signal (rh) */
...
typedef struct _Ifx_XSPI_ISR_Bits
{
    ...
    __I  Ifx_UReg_32Bit RSVD_9_RISR:1;     /**< \brief [9:9] Reserved bits - read as zero (r) */
    ...
    __I  Ifx_UReg_32Bit RSVD_12_32_RISR:20;    /**< \brief [31:12] Reserved bits - read as zero (r) */
} Ifx_XSPI_ISR_Bits;
...
typedef struct _Ifx_XSPI_MWCR_Bits
{
    __IO Ifx_UReg_32Bit MWMOD:1;           /**< \brief [0:0] Microwire Transfer Mode (rw) */
    __IO Ifx_UReg_32Bit MDD:1;             /**< \brief [1:1] Microwire Control (rw) */
    __IO Ifx_UReg_32Bit MHS:1;             /**< \brief [2:2] Microwire Handshaking (rw) */
    __I  Ifx_UReg_32Bit RSVD_MWCR:29;      /**< \brief [31:3] Reserved bits - read as zero (r) */
} Ifx_XSPI_MWCR_Bits;
...
{
    __IO Ifx_UReg_32Bit SDAR:32;           /**< \brief [31:0] SPI Device Address Register.This address will be used during read/write on SPI interface for DMA transfer (rw) */
} Ifx_XSPI_SPIAR_Bits;
...
typedef struct _Ifx_XSPI_SR_Bits
{
    ...
    __I  Ifx_UReg_32Bit CMPLTD_DF:17;      /**< \brief [31:15] Completed Data frames This field indicates total data frames transferred in the previous internal DMA transfer (r) */
} Ifx_XSPI_SR_Bits;
...
typedef union
{
    __IO Ifx_UReg_32Bit U;                 /**< \brief Unsigned access */
    __IO Ifx_SReg_32Bit I;                 /**< \brief Signed access */
    Ifx_XSPI_MWCR_Bits B;                  /**< \brief Bitfield access */
} Ifx_XSPI_MWCR;
...
typedef volatile struct _Ifx_XSPI
{
       ...
       __IO Ifx_XSPI_MWCR                       MWCR;                   /**< \brief 20C, Microwire Control Register*/
       ...
       __IO Ifx_XSPI_DR                         DR[36];                 /**< \brief 260, xSPI  Data Register*/
