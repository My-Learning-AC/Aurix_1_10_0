 ...
 *
 *
 * Version: MC_ACE_A3G_HSI_ADC/V0.2.3.1.0
...
typedef struct _Ifx_ADC_CDSP_DB_STATUS_Bits
{
    ...
    __I  Ifx_UReg_32Bit RD:1;              /**< \brief [2:2] The ready (RD) flag indicates whether the debug interface is available to accept another transaction command (rh) */
    ...
    __I  Ifx_UReg_32Bit RA:1;              /**< \brief [5:5] The Reset Applied (RA) flag is used by the debug host to determine that a target reset has occurred (rh) */
...
{
    __IO Ifx_UReg_32Bit SRTRS:6;           /**< \brief [5:0] Service request trigger source (rw) */
...
{
    __IO Ifx_UReg_32Bit SWTRS:6;           /**< \brief [5:0] Software trigger source (rw) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [7:6] \internal Reserved */
...
{
    __IO Ifx_UReg_32Bit TSTRS:6;           /**< \brief [5:0] Time stamp trigger source (rw) */
    __I  Ifx_UReg_32Bit :2;                /**< \brief [7:6] \internal Reserved */
