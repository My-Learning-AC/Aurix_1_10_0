...
/** \brief Length for Ifx_EGTM_DITH_ATCH_Bits.EDGESEL */
#define IFX_EGTM_DITH_ATCH_EDGESEL_LEN (1u)

/** \brief Mask for Ifx_EGTM_DITH_ATCH_Bits.EDGESEL */
#define IFX_EGTM_DITH_ATCH_EDGESEL_MSK (0x1u)

/** \brief Offset for Ifx_EGTM_DITH_ATCH_Bits.EDGESEL */
#define IFX_EGTM_DITH_ATCH_EDGESEL_OFF (3u)
