 ...
 */
#define IFXCSS_OP_ERRORMASK       ((uint32)(0xFFFFFFFF >> (32 - (IFX_CSS_CH_STAT_OPERR_ILSEQ_OFF + 1))))
...
/** \brief Channel Data Input Configuration CHx_CFG.DINCFG
 */
typedef enum
{
    IfxCss_channelDataInCfg_default     = 0,  /**< \brief Data is written in one transaction to the data input FIFO */
    IfxCss_channelDataInCfg_splitDataIn = 1,  /**< \brief Data written to the data input FIFO is split in two separate transactions */
    IfxCss_channelDataInCfg_aadFwd      = 2   /**< \brief Same as Split Data In + AAD is forwarded to Output FIFO */
} IfxCss_channelDataInCfg;
