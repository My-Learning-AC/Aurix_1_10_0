...
/**** Macro for Initial Pll step, for profile with 25MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1)}
...
#define IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_25MHZ_500MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */

#ifndef IFXCLOCK_CFG_PLL_STEPS_25MHZ_500MHZ
/**** Macro for Pll step for profile with 25MHz Crystal and 500MHz target (fDCO= 500MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_25MHZ_500MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_500MHZ_TO_TARGET_500MHZ
