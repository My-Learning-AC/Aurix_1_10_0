...
typedef struct _Ifx_VTMON_DTS_STAT_Bits
{
    ...
    __I  Ifx_UReg_32Bit BISTOK:1;          /**< \brief [15:15] BIST result (rh) */
...
/** \brief Die Temperature Sensor 0 Trim Register */
typedef struct _Ifx_VTMON_DTS_TRIM_Bits
{
    ...
    __IO Ifx_UReg_32Bit VCALTRIM:5;        /**< \brief [15:11] VCAL trim code (rwh) */
...
typedef volatile struct _Ifx_VTMON_DTS
{
       ...
       __IO Ifx_VTMON_DTS_TRIM                  TRIM;                   /**< \brief 1C, Die Temperature Sensor 0 Trim Register*/
} Ifx_VTMON_DTS;
...
typedef volatile struct _Ifx_VTMON
{
       ...
       __IO Ifx_VTMON_DTS                       DTS[5];                 /**< \brief 60, Die Temperature Sensor 0 Trim Register*/
