...
C_SRCS += \
../Components/simio/simio.c 

COMPILED_SRCS += \
Components/simio/simio.src 

C_DEPS += \
Components/simio/simio.d 

OBJS += \
Components/simio/simio.o 


# Each subdirectory must supply rules for building sources it contributes
Components/simio/simio.src: ../Components/simio/simio.c Components/simio/subdir.mk
...
Components/simio/simio.o: Components/simio/simio.src Components/simio/subdir.mk
	astc -Og -Os --no-warnings= --error-limit=42 --user-mode=hypervisor --core=tc1.8 -o  "$@" "$<"

clean: clean-Components-2f-simio

clean-Components-2f-simio:
	-$(RM) Components/simio/simio.d Components/simio/simio.o Components/simio/simio.src

.PHONY: clean-Components-2f-simio
